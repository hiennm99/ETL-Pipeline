...
def transform_data():
    raw_file=f'/opt/airflow/dags/data/raw_{runTime}.parquet'
    ...
    if check_data_integrity(dataframe=transformed_data):
        ...
        transform_file=f'/opt/airflow/dags/data/transformed_{runTime}.parquet'
